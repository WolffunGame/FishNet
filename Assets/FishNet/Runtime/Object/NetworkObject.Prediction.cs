...
namespace FishNet.Object
{
    ...
    public partial class NetworkObject : MonoBehaviour
    {
        ...
        [Tooltip("True if this object uses prediction methods.")] [SerializeField]
        ...
        private void TimeManager_OnPreTick() => _tickSmoother?.OnPreTick();
        private void TimeManager_OnPostTick() => _tickSmoother?.OnPostTick();
        ...
        private void Prediction_PreInitialize(NetworkManager manager, bool asServer)
        {
            ...
            if (asServer)
                return;
            if (_predictionBehaviours.Count <= 0) return;
        ...
        private void Prediction_Deinitialize()
        {
            if (!_enablePrediction)
                return;
            ...
            if (_predictionBehaviours.Count <= 0 || NetworkManager == null) return;
        ...
        private void InitializeSmoothers()
        {
            ...
            {
                Debug.Log(
                    $"GraphicalObject is null on {this.ToString()}. This may be intentional, and acceptable, if you are smoothing between ticks yourself. Otherwise consider assigning the GraphicalObject field.");
            }
            else
            {
        ...
        /// </summary>
        internal void RegisterPredictionBehaviourOnce(NetworkBehaviour nb)=> _predictionBehaviours.Add(nb);
